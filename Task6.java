...
public class Task6 {
	...
	public static void main(String[] args) {
		try(Connection con = DriverManager.getConnection(url,user_name,password);
			...
			System.out.println("Enter no.of records to be updated:");
			int n = SC.nextInt();
			...
			for(int i=0;i<n;i++) {
				...
				System.out.println("Enter row name to be updated(as per database) in id :"+id+" :");
				...
				if(row_name.equals("edep") || row_name.equals("ename") || row_name.equals("esal")) {
					...
					System.out.println("Enter valid row name: execution failed ");
				}
